            ...
            <div>
              ...
              <a href="#" class="btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
               ...
               @if($errors->has('category_id'))
                ...
                {!! Form::select('user_id',App\User::pluck('name','id'),null,['class'=>'form-control','placeholder'=>'Choose User','id'=>'user_id']) !!}
               @if($errors->has('user_id'))
                ...
                <div class="panel-footer sc post-meta padding-10 clearfix">
                 <a href="{{url('admin_iklan')}}" class="btn btn-success"><i class="glyphicon glyphicon-arrow-left"></i> Batal</a>
